...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-logging). This is required before any of your code or pull-requests are accepted.
...
Micronaut logging currently requires JDK 8.

## IDE Setup

Micronaut logging can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut logging tests currently require Docker to be installed.
